...
public class Engine
{
    ...
    public static void main(String[] args) {
        ...
        if(args.length > 0 && args[0].equals("--terraform")) //
        {
            boolean x = terraform();
        }
        if(args.length > 0 && args[0].equals("--debug_data")) //
        {
    ...
    private static final boolean terraform()
    {
        try
        (
    ...
    private static boolean debug_data()
    {
        ...
        {
            Statement statement = connection.createStatement();
            // Esegui ogni INSERT separatamente
            String[] queries = {
