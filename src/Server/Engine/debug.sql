...
CREATE TABLE IF NOT EXISTS events (eventName VARCHAR(64) UNIQUE, eventDescription VARCHAR(512), city VARCHAR(16), address VARCHAR(64), meetingPoint VARCHAR(64), startDate INT, endDate INT, organization VARCHAR(32), minUsers INT, maxUsers INT,  maxFriends INT, visitType VARCHAR(32), state VARCHAR(16), ticketPrice FLOAT);

INSERT INTO events VALUES ('Cinema in Castello: la corazzata Potiomkin', 'Terna di serate per ammirare i grandi capolavori cinematografici del Novecento, ore 21:00', 'Bergamo', 'Castello di Bergamo', 'Entrata del castello', 1770411600, 1770584400, 'San Genesio', 50, 500, 4, 'Cinema', 'PROPOSED', 0.0);
INSERT INTO events VALUES ('Cinema in Castello: il deserto rosso', 'Terna di serate per ammirare i grandi capolavori cinematografici del Novecento, ore 21:00', 'Bologna', 'Castello di Bologna', 'Entrata del castello',1761944400, 1762117200, 'San Genesio', 50, 500, 4, 'Cinema', 'PROPOSED', 0.0);
INSERT INTO events VALUES ('Le quattro stagioni al parco', 'Ascoltate le quattro stagioni di Vivaldi al parco di Verona', 'Verona', 'Parco di Verona', 'Entrata del parco', 1, 2, 'Santa Cecilia', 25, 75, 3, 'Concerto', 'PROPOSED', 0.0);
