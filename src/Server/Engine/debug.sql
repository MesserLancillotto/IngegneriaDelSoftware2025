...
INSERT INTO users VALUES ('Antonio Vivaldi', 'Venezia', 1978, 'CONFIGURATOR.Antonio.Vivaldi.78', 'rosso', 'CONFIGURATOR', 'Santa Cecilia');
...
CREATE TABLE IF NOT EXISTS events (eventName VARCHAR(64) UNIQUE, eventDescription VARCHAR(512), city VARCHAR(16), address VARCHAR(64), startDate INT, endDate INT, organization VARCHAR(32), minUsers INT, maxUsers INT,  maxFriends INT, visitType VARCHAR(32), confirmed BOOLEAN);
